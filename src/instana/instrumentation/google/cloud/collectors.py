...
_storage_api = {
    "GET": {
        ...
        re.compile("^/b/(?P<bucket>[^/]+)/iam/testPermissions$"): lambda params,
        data,
        match: {
        ...
        ##########################
        re.compile("^/b/(?P<bucket>[^/]+)/o/(?P<object>[^/]+)$"): lambda params,
        data,
        match: {
            "gcs.op": params.get("alt", "json") == "media"
            and "objects.get"
            or "objects.attrs",
            "gcs.bucket": unquote(match.group("bucket")),
        ...
        ##################################
        re.compile(
            "^/b/(?P<bucket>[^/]+)/defaultObjectAcl/(?P<entity>[^/]+)$"
        ): lambda params, data, match: {
            "gcs.op": "defaultAcls.get",
            "gcs.bucket": unquote(match.group("bucket")),
            "gcs.entity": unquote(match.group("entity")),
        },
        re.compile("^/b/(?P<bucket>[^/]+)/defaultObjectAcl$"): lambda params,
        data,
        match: {
        ...
        #########################
        re.compile(
            "^/b/(?P<bucket>[^/]+)/o/(?P<object>[^/]+)/acl/(?P<entity>[^/]+)$"
        ): lambda params, data, match: {
        ...
        re.compile("^/b/(?P<bucket>[^/]+)/o/(?P<object>[^/]+)/acl$"): lambda params,
        data,
        match: {
        ...
        ########################
        re.compile("^/projects/(?P<project>[^/]+)/hmacKeys$"): lambda params,
        data,
        match: {
        ...
        re.compile(
            "^/projects/(?P<project>[^/]+)/hmacKeys/(?P<accessId>[^/]+)$"
        ): lambda params, data, match: {
            "gcs.op": "hmacKeys.get",
            "gcs.projectId": unquote(match.group("project")),
        ...
        ##############################
        re.compile("^/projects/(?P<project>[^/]+)/serviceAccount$"): lambda params,
        data,
        match: {
    ...
    "POST": {
        ...
        re.compile("^/b/(?P<bucket>[^/]+)/lockRetentionPolicy$"): lambda params,
        data,
        match: {
        ...
        # Object/blob operations #
        ##########################
        re.compile("^/b/(?P<bucket>[^/]+)/o/(?P<object>[^/]+)/compose$"): lambda params,
        data,
        match: {
            ...
            "gcs.sourceObjects": ",".join(
                [
                    "%s/%s" % (unquote(match.group("bucket")), o["name"])
                    for o in data.get("sourceObjects", [])
                    if "name" in o
                ]
            ),
        },
        re.compile(
            "^/b/(?P<srcBucket>[^/]+)/o/(?P<srcObject>[^/]+)/copyTo/b/(?P<destBucket>[^/]+)/o/(?P<destObject>[^/]+)$"
        ): lambda params, data, match: {
            "gcs.op": "objects.copy",
        ...
        re.compile(
            "^/b/(?P<srcBucket>[^/]+)/o/(?P<srcObject>[^/]+)/rewriteTo/b/(?P<destBucket>[^/]+)/o/(?P<destObject>[^/]+)$"
        ): lambda params, data, match: {
