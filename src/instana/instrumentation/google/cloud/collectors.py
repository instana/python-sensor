...
_storage_api = {
    "GET": {
        ...
        re.compile(
            "^/b/(?P<bucket>[^/]+)/iam/testPermissions$"
        ...
        ##############################
        re.compile(
            "^/projects/(?P<project>[^/]+)/serviceAccount$"
        ): lambda params, data, match: {
    ...
    "POST": {
        ...
        re.compile(
            "^/b/(?P<bucket>[^/]+)/lockRetentionPolicy$"
        ): lambda params, data, match: {
        ...
        re.compile(
            ...
            "gcs.sourceObjects": ",".join([
                "{}/{}".format(unquote(match.group("bucket")), o["name"])
