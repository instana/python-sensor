...
_QUESTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="question",
            full_name="stan.QuestionRequest.question",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_QUESTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="answer",
            full_name="stan.QuestionResponse.answer",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="was_answered",
            full_name="stan.QuestionResponse.was_answered",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
QuestionRequest = _reflection.GeneratedProtocolMessageType(
    "QuestionRequest",
    (_message.Message,),
    {
...
QuestionResponse = _reflection.GeneratedProtocolMessageType(
    "QuestionResponse",
    (_message.Message,),
    {
