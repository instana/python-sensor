...
class TestPyramid(unittest.TestCase):
    ...
    def test_get_request(self):
        ...
        self.assertEqual(
            "127.0.0.1:" + str(testenv["pyramid_port"]), sdk_custom_tags["http.host"]
        )
        ...
        self.assertEqual(
            testenv["pyramid_server"] + "/", urllib3_span.data["http"]["url"]
        )
    ...
    def test_500(self):
        ...
        self.assertEqual(
            testenv["pyramid_server"] + "/500", urllib3_span.data["http"]["url"]
        )
        self.assertEqual("GET", urllib3_span.data["http"]["method"])
        self.assertIsNotNone(urllib3_span.stack)
        self.assertTrue(type(urllib3_span.stack) is list)
