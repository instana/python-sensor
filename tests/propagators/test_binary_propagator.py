...
class TestBinaryPropagator(unittest.TestCase):
    ...
    def test_inject_carrier_dict_w3c_True(self):
        ...
        self.assertEqual(carrier[b"x-instana-t"], b"1234d0e0e4736234")
        self.assertEqual(
            carrier[b"traceparent"],
            b"00-00000000000000001234d0e0e4736234-1234567890abcdef-01",
        )
        self.assertEqual(
            carrier[b"tracestate"], b"in=1234d0e0e4736234;1234567890abcdef"
        )
    ...
    def test_inject_carrier_list_w3c_True(self):
        ...
        self.assertEqual(
            carrier[1], (b"tracestate", b"in=1234d0e0e4736234;1234567890abcdef")
        )
